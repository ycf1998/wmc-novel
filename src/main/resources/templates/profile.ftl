    ...
    <div class="layuimini-main">
        ...
        <div class="layui-form layuimini-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="number" name="phone" lay-reqtext="手机不能为空" placeholder="请输入手机"  value="${(admin.phone)!""}" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
...
<script src="/wmc-novel/static/js/lay-config.js?v=1.0.4" charset="utf-8"></script>
<script>
